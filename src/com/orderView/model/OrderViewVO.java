...
public class OrderViewVO  implements Serializable {
	...
	public String toString() {
		return "OrderViewVO [order_detail_no=" + order_detail_no + ", product_no=" + product_no + ", product_price="
				+ product_price + ", product_amount=" + product_amount + ", product_total=" + product_total
				+ ", order_serial_no=" + order_serial_no + ", receive_name=" + receive_name + ", receive_phone_num="
				+ receive_phone_num + ", receive_address=" + receive_address + ", status=" + status + ", product_name="
				+ product_name + ", user_no=" + user_no + "]";
	}
