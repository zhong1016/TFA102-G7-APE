...
public class PicReader extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			int manager_no = managerVO.getManager_no();		
			ResultSet rs = stmt.executeQuery(
				"select headshot from manager where manager_no="+ manager_no);	

			if(rs.next()) {
				BufferedInputStream in = new BufferedInputStream(rs.getBinaryStream("headshot"));
