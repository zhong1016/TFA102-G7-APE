 ...
 */
@WebServlet("/CopPic")
public class CopPic extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			ResultSet rs = stmt.executeQuery("SELECT COMPANY_BRC FROM COMPANY WHERE COMPANY_NO=" + companyNo);	
			System.out.println(rs.next());
			if(rs.next()) {
				BufferedInputStream in = new BufferedInputStream(rs.getBinaryStream("COMPANY_BRC"));
