...
public class MemPicReader extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			ResultSet rs = stmt
					.executeQuery("SELECT user_pic FROM members WHERE user_no = " + req.getParameter("user_no"));
			System.out.println(req.getParameter("user_no") + "123");
			if (rs.next()) {
