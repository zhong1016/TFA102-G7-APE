			...
			<div class="panel-text">
				...
				<FORM METHOD="post" ACTION="location.do" name="form1">
					...
					<div class="worker_data">
						<td>展區編號:<font color=red><b>*</b></font></td>
						<td><%=locationVO.getLocationno()%></td>
					</div>
					...
					<div class="worker_maindata">
						...
						<table style="margin: auto;margin-top: 5%">
							<tr>
								<th>展區名稱:</th>
								<td class="name"><input type="TEXT" name="locationname"
									size="30" value="<%=locationVO.getLocationname()%>" /></td>
							</tr>

							<tr>
								<th>展區地址:</th>
								<td class="email"><input type="TEXT" name="locationadd"
									size="30" value="<%=locationVO.getLocationadd()%>" /></td>
							</tr>

						</table>
					</div>
					<input type="hidden" name="action" value="update"> <input
						type="hidden" name="locationno"
						value="<%=locationVO.getLocationno()%>"> <input
						type="hidden" name="requestURL"
						value="listAllLocation.jsp">
