	...
	<div class="main">
		...
		<div class="main-div">
			...
			<div class="panel-text">
				...
				<div class="h1">
					<a
						href="<%=request.getContextPath()%>/map/location/listAllLocation.jsp">
						<p>展區列表</p>
				</div>
				<div>
					<a href="<%=request.getContextPath()%>/map/MapManagement.jsp"><img
						class="logo" src="<%=request.getContextPath()%>/img/APE3.svg" alt="" /></a>
				</div>
			</header>
				<div class="line"></div>
				<div class="plus_management">
					<a
						...
						<p style="font-weight:bold;font-size: 2rem;text-align: center;">新增餐廳</p>
					</a>
				</div>
				<div class="line"></div>
				<!-- 餐廳列表 -->
				...
				<div class="management_list">
					<table>
						...
						<%@ include file="/map/restaurant/page1.file"%>
								...
								<td>
									<FORM METHOD="post"
										...
										<input type="submit" value="修改"> <input type="hidden"
											name="restaurantno" value="${restaurantVO.restaurantno}">
								...
								<br>
									<FORM METHOD="post"
										...
										<input type="submit" value="刪除"> <input type="hidden"
											name="restaurantno" value="${restaurantVO.restaurantno}"> <input type="hidden" name="requestURL"
											value="<%=request.getServletPath()%>">
										<!--送出本網頁的路徑給Controller-->
										<input type="hidden" name="whichPage" value="<%=whichPage%>">
					...
					<%@ include file="/map/restaurant/page2.file"%>
